...
While building the sanctions module for Devbrew’s [AI fraud detection case study](/case-studies/fraud-detection), we ran into the same tradeoff every payments team eventually faces.
...
**P.S.** If you want to dive deeper, you can follow the applied AI research case study here: [AI fraud detection for cross border payments](https://www.devbrew.ai/case-studies/fraud-detection)
