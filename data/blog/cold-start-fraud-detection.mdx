...
If you are processing \$20M+ annually and running rules based fraud detection, get in touch through our [contact page](https://devbrew.ai/contact) to discuss your cold start fraud detection implementation.
