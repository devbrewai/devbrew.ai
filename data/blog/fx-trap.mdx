...
If you want support optimizing the FX stack, [Devbrew](https://devbrew.ai) builds applied AI systems that help payments companies recover margin and reduce silent leakage. For a clear view of what this could look like for your business, you can book an AI strategy call with me. I will walk through how similar teams uncover hidden spread loss and recover 2 to 5 basis points of margin. You can schedule your session here: [**Schedule your session**](https://cal.com/joekariuki/ai-strategy-call)

Let’s talk about how much margin can be recovered.
