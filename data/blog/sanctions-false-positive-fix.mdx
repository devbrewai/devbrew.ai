...
You can see this architecture in practice in our [Sentinel case study](/work/sentinel), where we built a sanctions screening engine with sub-50ms latency and 97.5\% precision against OFAC watchlists.
