...
images: ['/static/images/case-studies/ai-fraud-detection-cross-border-payments/og.png']
authors: ['default']
layout: PostLayout
canonicalUrl: 'https://www.devbrew.ai/case-studies/ai-fraud-detection-cross-border-payments'
---
...
**Repository**: [github.com/devbrewai/ai-fraud-detection-cross-border-payments](https://github.com/devbrewai/ai-fraud-detection-cross-border-payments)
